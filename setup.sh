...
echo
echo "Downloading datasets and moving in to src/resources/ directory"
...
wget -q -O tmp.zip https://zenodo.org/record/4008239/files/sub-twitter-1.0.0.zip && unzip tmp.zip && rm tmp.zip
mv sub-twitter-1.0.0/sub-twitter-1.0.0.xml src/resources/
rm -rf sub-twitter-1.0.0

## GOOGLE TASKS DATASET
...
wget -q -O tmp.zip https://zenodo.org/record/4008239/files/sub-slack-1.0.0.zip && unzip tmp.zip && rm tmp.zip
mv sub-slack-1.0.0/sub-slack-1.0.0.xml src/resources/
rm -rf sub-slack-1.0.0

## GHTRAFFIC DATASETS
wget -q -O tmp.zip https://zenodo.org/record/4007589/files/ghtraffic-S-2.0.0.zip && unzip tmp.zip && rm tmp.zip
mv ghtraffic-S-2.0.0/ghtraffic-S-2.0.0.json src/resources/
rm -rf ghtraffic-S-2.0.0

wget -q -O tmp.zip https://zenodo.org/record/4008239/files/sub-ghtraffic-S-2.0.0.zip && unzip tmp.zip && rm tmp.zip
